 ...
 */
public class BwaPairedAlignment extends BwaAlignmentBase implements Function2<Integer,Iterator<Tuple2<Text,Text>>,Iterator<String>>{
     ...
     */
    public Iterator<String> call(Integer arg0, Iterator<Tuple2<Text,Text>> arg1)
            throws Exception {
