...
public class BwaSingleAlignment extends BwaAlignmentBase implements Function2<Integer, Iterator<Text>, Iterator<String>>{
     ...
     */
    public Iterator<String> call(Integer arg0, Iterator<Text> arg1)
            throws Exception {
